<html>
<head>
    <title>{{config('webset.webname')}}-404提示</title>
    <!-- Meta tag Keywords -->
    ...
    <!-- Meta tag Keywords -->
    <!-- css files -->
    <link href="/public/static/wapian/css/404.css" rel="stylesheet" type="text/css" media="all">
    <link rel="stylesheet" href="/public/static/wapian/css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
    <!-- //css files -->
</head>
<body>
<div class="header">
