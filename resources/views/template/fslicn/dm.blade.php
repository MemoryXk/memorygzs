            ...
            <div class="hy-cascade clearfix">
                <div class="left-head hidden-sm hidden-xs">
                    <ul class="clearfix">
                        ...
                        <li><a href="/dmlist/all/1.html" class="active">动漫</a></li>
                        </ul>
                </div>
                <div class="content-meun clearfix">
                    <a class="head" href="/dmlist/all/1.html" data-toggle="collapse" data-target="#collapse"> </a>
                    <div class="item collapse in" id="collapse">
                        <ul class="visible-sm visible-xs clearfix">
                            ...
                            <li><a class="active" href="/dmlist/all/1.html" target="_self" id="idc4ca4238a0b923820dcc509a6f75849b">动漫</a></li>
						</ul>

                        <ul class="clearfix">
                            <li><a href="/dmlist/all/1.html" class="acat {{$cat=='all'?'active':''}}" style="white-space: pre-wrap;">全部</a></li>
                            @foreach($dmtype as $key=>$v)
                               <li><a href='/dmlist/{{$v}}/1.html' class='acat {{$cat==$v?'active':''}}' style='white-space: pre-wrap;margin-bottom: 4px;'>{{$key}}</a></li>
                            @endforeach
