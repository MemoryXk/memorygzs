                                    ...
                                    <div class="panel clearfix">
                                        ...
                                        <div id="playlist1" class="playlist collapse in dianshijua">
                                            <ul class="playlistlink-1 list-15256 clearfix">
                                                @foreach($zylist as $v)
                                                    <li>
                                                        <a href="javascript:void(0)" target="_self"  class="am-btn am-btn-default lipbtn" style="" data-href='{{isset($v['href'])?$v['href']:'#'}}' onclick="bofang(this)">{{isset($v['href'])?$v['time']:'暂无可用播放源'}}</a>
                                                    </li>
                                                @endforeach
                                            </ul>
                                    ...
                                    <div class="swiper-wrapper">
                                        @foreach($like as $v)
                                            <div class="swiper-slide" style="width: 166.6px;">
                                                <div class="item">
                                                    <a class="videopic lazy" href="/play/{{$v['url']}}.html" title="{{$v['title']}}" data-src="{{$v['img']}}">
                                                        <span class="play hidden-xs"></span>
                                                        <span class="score">推荐</span></a>
                                                    <div class="title">
                                                        <h5 class="text-overflow"><a href="/play/{{$v['url']}}.html">{{$v['title']}}</a></h5>
                                                    </div>
