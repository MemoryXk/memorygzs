...
<head>
    ...
    <!-- Meta tag Keywords -->
    <!-- css files -->
    <link href="/public/static/fslicn/css/404.css" rel="stylesheet" type="text/css" media="all">
    <link rel="stylesheet" href="/public/static/fslicn/css/font-awesome.css"> <!-- Font-Awesome-Icons-CSS -->
    <!-- //css files -->
</head>
<body>
<div class="header">
