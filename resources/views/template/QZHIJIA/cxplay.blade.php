			...
			<div class="stui-pannel-box">
				<div class="stui-pannel-bd">
					...
					<img id="addid" src="#" style="display: none;width:100%;border: 2px solid #ff6651">
						...
						<span class="text-muted" id="xuji">正在播放：{{$info['dyname']}}</span></div>
				...
				<div class="dscontent">
							...
							<div class="detail-content" style="display: none;">
								...
								<p class="desc margin-0"><span class="left text-muted">简介：</span><span style="font-variant-ligatures: normal; orphans: 2; widows: 2;">{{$info['dydesc']}}</span></p>
							</div>
						</div>
					</div>
				</div>
...
@foreach($playinfo as $key=>$arr)
	<div class="stui-pannel-box">
		<div class="stui-pannel_hd" id="accordion">
			<div class="stui-pannel__head bottom-line active clearfix">
				<a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#cx{{$playtype[$key]}}">
				<span class="more text-muted pull-right">无需安装任何插件，点播放源可折叠！</span>
					<h3 class="title">{{$playtype[$key]}}</h3>
				</a>
				</div>
			</div>
		<div class="stui-pannel_bd col-pd clearfix">
			<ul class="stui-content__playlist column10 clearfix collapse in" id="cx{{$playtype[$key]}}"> 
			@foreach($arr as $v)
				<li>
