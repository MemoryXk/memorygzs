...
<div class="stui-pannel stui-pannel-bg clearfix">
	<div class="stui-pannel-box">
		...
		<div class="stui-pannel_bd col-pd clearfix">
			...
			@foreach($dyplay as $v)
				<li><a href="javascript:void (0)" data-href="{{isset($v['play'])?$v['play']:'#'}}" onclick="bofang(this)" target="_self" class="am-btn am-btn-default lipbtn">{{isset($v['play'])?$v['playname']:'暂无可用播放源'}}</a></li>
			@endforeach
			</ul>
		</div>
	</div>
