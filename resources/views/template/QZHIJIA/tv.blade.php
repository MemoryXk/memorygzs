			...
			<div class="stui-pannel-box">
				<div class="stui-pannel_hd">
					<div class="stui-pannel__head active bottom-line clearfix">
						<h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_28.png"/>最新电视剧</h3>
	   ...
	   @foreach($dsj as $ds)
        <li class="col-md-6 col-sm-4 col-xs-3">
         <div class="stui-vodlist__box">
          <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$ds['url']}}.html" onclick="jilu(this)" title="{{$ds['title']}}" data-src="{{$ds['img']}}">
