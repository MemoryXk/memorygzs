...
$("#首页").attr("class","active");
   ...
   <div class="row">
	...
	<div class="stui-pannel stui-pannel-bg clearfix">
     <div class="stui-pannel-box clearfix">
            <marquee style="width: 100%;color: #3ACEED;font-size: 20px;padding-top: 5px;padding-bottom: 5px;">{{config('webset.notice')}}</marquee>
                      </div>
                    </div>
                        </div>
                    </div>
     ...
     <div class="stui-pannel-box clearfix">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_1.png" />会员视频</h3>
        </div>
       </div>
       <div class="stui-pannel_bd clearfix">
        <ul class="stui-vodlist clearfix">
			...
			<a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$dy['dy_id']}}.html" onclick="jilu(this)" title="{{$dy['dy_title']}}" data-src="{{$dy['dy_img']}}">		   
			  ‭ ‭‭‭ ‭ ‭‭ ‭ ‭‭‭‭‭ ‭ ‭‭‭ ‭‭‭‭‭ ‭  ‭‭‭‭‭‭‭<span class="play hidden-xs"></span><span class="pic-text text-right"></span>留言专属</a>           
      ...
      <div class="col-lg-wide-25 hidden-md hidden-sm hidden-xs">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         <a class="more text-muted pull-right" href="/viplist.html">更多 <i class="icon iconfont icon-more"></i></a>
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_12.png" />
         热播榜</h3>
        </div>
       </div>
     ...
     <div class="stui-pannel-box clearfix">
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_9.png" />最近更新</h3>
         @foreach($videotype['cx'] as $key=>$type)
		 <ul class="nav nav-text pull-right @if($loop->index>4) hidden-xs hidden-md @endif">
			<li><a href="/autocxlist/{{$type}}/1.html" class="text-muted">{{$key}}</a> <span class="split-line"></span></li>
		 </ul>
          @break($loop->index==2)
         @endforeach
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        <ul class="stui-vodlist clearfix">
			...
			<div class="stui-vodlist__box">           
			<a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$dy['dy_addr']}}.html" onclick="jilu(this)" title="{{$dy['dy_title']}}" data-src="{{$dy['dy_img']}}">   
      ...
      <div class="col-lg-wide-25 hidden-md hidden-sm hidden-xs">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         <a class="more text-muted pull-right" href="/autocxlist/5/1.html">更多 <i class="icon iconfont icon-more"></i></a>
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_12.png" />热播榜</h3>
        </div>
       </div>
       <div class="stui-pannel_bd">
        <ul class="stui-vodlist__rank col-pd clearfix">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_7.png" />电影</h3>
		 @foreach($videotype['movie'] as $key=>$type)
		 <ul class="nav nav-text pull-right @if($loop->index>4) hidden-xs hidden-md @endif">
			<li><a href="/movielist/{{$type}}/1.html" class="text-muted">{{$key}}</a> <span class="split-line"></span></li>
		 </ul>
		 @break($loop->index==3)
         @endforeach
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        <ul class="stui-vodlist clearfix">
		 ...
		 <li class="col-md-5 col-sm-4 col-xs-3 @if($loop->index>4) hidden-lg hidden-md @endif" id="vodlist-{{$dy['url']}}">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$dy['url']}}.html" onclick="jilu(this)" title="{{$dy['title']}}" data-src="{{$dy['img']}}">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_2.png" />电视剧</h3>
		 @foreach($videotype['tv'] as $key=>$type)
		 <ul class="nav nav-text pull-right @if($loop->index>4) hidden-xs hidden-md @endif">
			<li><a href="/tvlist/{{$type}}/1.html" class="text-muted">{{$key}}</a> <span class="split-line"></span></li>
		 </ul>
		 @break($loop->index==3)
         @endforeach
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        ...
        @foreach($dsjs as $dsj)
		 <li class="col-md-5 col-sm-4 col-xs-3 @if($loop->index>4) hidden-lg hidden-md @endif" id="vodlist-{{$dsj['url']}}">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$dsj['url']}}.html" onclick="jilu(this)" title="{{$dsj['title']}}" data-src="{{$dsj['img']}}">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_3.png" />综艺</h3>
		 @foreach($videotype['zy'] as $key=>$type)
		 <ul class="nav nav-text pull-right @if($loop->index>4) hidden-xs hidden-md @endif">
			<li><a href="/zylist/{{$type}}/1.html" class="text-muted">{{$key}}</a> <span class="split-line"></span></li>
		 </ul>
		 @break($loop->index==3)
         @endforeach
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        ...
        @foreach($zys as $zy)
		 <li class="col-md-5 col-sm-4 col-xs-3 @if($loop->index>4) hidden-lg hidden-md @endif" id="vodlist-{{$zy['url']}}">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$zy['url']}}.html" onclick="jilu(this)" title="{{$zy['title']}}" data-src="{{$zy['img']}}">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
         ...
         <h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_4.png" />动漫</h3>
		 @foreach($videotype['dm'] as $key=>$type)
		 <ul class="nav nav-text pull-right @if($loop->index>4) hidden-xs hidden-md @endif">
			<li><a href="/dmlist/{{$type}}/1.html" class="text-muted">{{$key}}</a> <span class="split-line"></span></li>
		 </ul>
		 @break($loop->index==3)
         @endforeach
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        ...
        @foreach($dms as $dm)
		 <li class="col-md-5 col-sm-4 col-xs-3 @if($loop->index>4) hidden-lg hidden-md @endif" id="vodlist-{{$dm['url']}}">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/{{$dm['url']}}.html" onclick="jilu(this)" title="{{$dm['title']}}" data-src="{{$dm['img']}}">
