...
<span class="text-muted" id="xuji">正在播放：{{$pm}}<span class="js"></span></span>
...
<div class="stui-pannel stui-pannel-bg clearfix">
	<div class="stui-pannel-box"><div class="stui-pannel_hd">
		<div class="stui-pannel__head bottom-line active clearfix">
          <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#tv{{$v['name']}}">
	...
	<div class="stui-pannel_bd col-pd clearfix">
		<ul class="stui-content__playlist column10 clearfix collapse in" id="tv{{$v['name']}}">
