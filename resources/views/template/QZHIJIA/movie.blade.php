			...
			<div class="stui-pannel-box">
				<div class="stui-pannel_hd">
					<div class="stui-pannel__head active bottom-line clearfix">
						<h3 class="title"><img src="/public/static/QZHIJIA/icon/icon_28.png"/>最新电影</h3>
	   ...
	   @foreach($dys as $dy)
        <li class="col-md-6 col-sm-4 col-xs-3">
         <div class="stui-vodlist__box">
          <a class="stui-vodlist__thumb lazyload im-shadow" href="/play/{{$dy['url']}}.html" title="{{$dy['title']}}" data-src="{{$dy['img']}}">
