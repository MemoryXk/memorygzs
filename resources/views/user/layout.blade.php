    ...
    <div class="sidebar-menu toggle-others fixed">
        ...
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <li class="@yield('userindex')">
                    <a href="/ucenter.html">
                        <i class="linecons-desktop"></i>
                        <span class="title">会员中心</span>
                    </a>
                </li>
                <li class="@yield('userinfo')">
                    <a href="#">
                        <i class="linecons-cog"></i>
                        <span class="title">会员信息</span>
                    </a>
                    <ul>
                        <li class="@yield('changeinfo')">
                ...
                <li class="@yield('kamipay')">
                    <a href="/chongzhi.html">
                        <i class="linecons-fire"></i>
                        <span class="title">升级会员</span>
                    </a>
                </li>
                <li class="@yield('kamibuy')">
                    <a href="{{config('userconfig.kamibuy')??'http://www.baidu.com'}}">
