            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-4"><p>验证码:<a href="#" onclick="document.getElementById('captcha_img').src='./yanzheng.php?r='+Math.random()"> <img id="captcha_img" border='1' src='./yanzheng.php?r=echo rand(); ?>' style="width:100px; height:30px" /></a>
  </p></label>
