        ...
        <div class="sidebar-menu-inner">
            ...
            <ul id="main-menu" class="main-menu">
                ...
                <li class="@yield('new')">
                    ...
                    <ul>
                        <li class="@yield('autocx')">
                            <a href="/{{config('webset.webdir')}}/autocx">
                ...
                <li class="@yield('user')">
                    ...
                    <ul>
                        <li class="@yield('userlist')">
                            <a href="/{{config('webset.webdir')}}/userlist">
                                <span class="title">会员列表</span>
                            </a>
                        </li>
                        <li class="@yield('userset')">
                            <a href="/{{config('webset.webdir')}}/userset">
                ...
                <li class="@yield('kami')">
                    ...
                    <ul>
                        <li class="@yield('kamilist')">
                            <a href="/{{config('webset.webdir')}}/kamilist.html">
                                <span class="title">卡密列表</span>
                            </a>
                        </li>
                        <li class="@yield('kamisc')">
                            <a href="/{{config('webset.webdir')}}/makekami.html">
                ...
                <li class="@yield('zb')">
                    ...
                    <ul>
                        ...
                        <li class="@yield('addzb2')">
                            <a href="/{{config('webset.webdir')}}/addzb2">
