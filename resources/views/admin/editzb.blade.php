                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" value="{{$zb['zb_id']}}" id="zbid" name="zb_id">
                                <input type="text" class="form-control" id="field-1" value="{{$zb['zb_title']}}" name="zb_title" placeholder="请输入直播名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-7" name="zb_addr" value="{{$zb['zb_addr']}}" placeholder="请输入直播地址" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-8" name="zb_sort" value="{{$zb['zb_sort']}}" placeholder="请填写排序数字,数字越大越靠前" required>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <select class="form-control" name="zb_type" id="field-9">
                                    <option value="1" {{$zb['zb_type']==1?'selected':''}}>央视频道</option>
                                    <option value="2" {{$zb['zb_type']==2?'selected':''}}>卫视频道</option>
                                    <option value="3" {{$zb['zb_type']==3?'selected':''}}>其他频道</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
