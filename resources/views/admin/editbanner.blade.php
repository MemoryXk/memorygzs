                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                ...
                                <input type="text" class="form-control" id="field-1" value="{{$banner['banner_title']}}" name="banner_title" placeholder="请输入轮播名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-2" value="{{$banner['banner_img']}}" name="banner_img" placeholder="请输入轮播图片地址" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-3" name="banner_link" value="{{$banner['banner_link']}}" placeholder="请输入轮播链接地址" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
