            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                @foreach($qqlist as $key=>$v)
                    <tr>
                        ...
                        <td>{{$v['tort_addr']}}</td>
                        <td>
                            <a href="/{{config('webset.webdir')}}/editqq/{{$v['tort_id']}}" class="btn btn-secondary btn-sm btn-icon icon-left">
                                编辑
                            </a>

                            <a href="javascript:void(0)" onclick="shanchu(this)" goodid="{{$v['tort_id']}}" class="btn btn-danger btn-sm btn-icon icon-left">
                                删除
                            </a>
                        </td>
                    </tr>
