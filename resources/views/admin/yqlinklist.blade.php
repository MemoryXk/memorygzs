    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                @foreach($yqlist as $key=>$v)
                    <tr>
                        <td>{{$v['yq_name']}}</td>
                        <td>{{$v['yq_link']}}</td>
                        <td>
                            <a href="/{{config('webset.webdir')}}/edityqlink/{{$v['yq_id']}}" class="btn btn-secondary btn-sm btn-icon icon-left">
                                编辑
                            </a>

                            <a href="javascript:void(0)" onclick="shanchu(this)" goodid="{{$v['yq_id']}}" class="btn btn-danger btn-sm btn-icon icon-left">
                                删除
                            </a>
                        </td>
                    </tr>
