                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" value="{{$nav['nav_id']}}" name="nav_id">
                                <input type="text" class="form-control" id="field-1" value="{{$nav['nav_title']}}" name="nav_title" placeholder="请输入导航名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-2" value="{{$nav['nav_addr']}}" name="nav_addr" placeholder="请输入导航地址" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-3" name="nav_sort" value="{{$nav['nav_sort']}}" placeholder="数字越大越靠前" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
