                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" value="{{$tort['tort_id']}}" name="tort_id">
                                <input type="text" class="form-control" id="field-1" value="{{$tort['tort_name']}}" name="tort_name" placeholder="请输入友链名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-3" name="tort_addr" value="{{$tort['tort_addr']}}" placeholder="请输入友链地址" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
