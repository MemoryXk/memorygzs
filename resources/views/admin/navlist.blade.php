            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                @foreach($navlist as $key=>$v)
                    <tr>
                        ...
                        <td>{{$v['nav_sort']}}</td>
                        <td>
                            <a href="/{{config('webset.webdir')}}/editnav/{{$v['nav_id']}}" class="btn btn-secondary btn-sm btn-icon icon-left">
                                编辑
                            </a>

                            <a href="javascript:void(0)" onclick="shanchu(this)" goodid="{{$v['nav_id']}}" class="btn btn-danger btn-sm btn-icon icon-left">
                                删除
                            </a>
                        </td>
                    </tr>
