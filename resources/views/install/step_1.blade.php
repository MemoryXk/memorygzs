	...
	<div class="forms">
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			<tr>
				...
				<td>不限制</td>
				<td>类Unix</td>
				<td class="endCol">{{$info['os']}}</td>
			</tr>
			<tr>
				<td height="26" class="firstCol">PHP 版本</td>
				<td>7.0</td>
				<td>7.1</td>
				<td class="endCol">{{$info['version']}}</td>
			</tr>
			<tr>
				<td height="26" class="firstCol">附件上传</td>
				<td>不限制</td>
				<td>2M</td>
				<td class="endCol">{{$info['upsize']?$info['upsize']:'不支持附件上传'}}</td>
			</tr>
			<tr>
				<td height="26" class="firstCol">GD 库</td>
				<td>1.0</td>
				<td>2.0</td>
				<td class="endCol">{{$info['gd']}}</td>
			</tr>
			<tr>
				<td height="26" class="firstCol">磁盘空间</td>
				<td>10M</td>
				<td>不限制</td>
				<td class="endCol">{{$info['disk']}}</td>
			</tr>
		</table>
		<div class="hr_10"></div>
		<table width="100%" border="0" cellpadding="0" cellspacing="0">
			...
			@foreach($info['function'] as $key=>$v)
			<tr>
				<td height="26" class="firstCol">{{$key}}()</td>
				<td>支持</td>
				<td class="endCol">{{$v}}</td>
			</tr>
			@endforeach
		</table>
	</div>
