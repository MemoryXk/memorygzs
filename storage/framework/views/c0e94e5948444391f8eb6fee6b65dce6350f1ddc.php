...
<?php $__env->startSection('title','火爆综艺'); ?>
            ...
            <div class="hy-cascade clearfix">
                ...
                <div class="content-meun clearfix">
                    ...
                    <div class="item collapse in" id="collapse">
                        ...
                        <ul class="clearfix">
                            <li><a href="/zylist/all/1.html" class="acat <?php echo e($cat=='all'?'active':''); ?>" style="white-space: pre-wrap;">全部</a></li>
                            <?php $__currentLoopData = $zytype; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <li><a href='/zylist/<?php echo e($v); ?>/1.html' class='acat <?php echo e($cat==$v?'active':''); ?>' style='white-space: pre-wrap;margin-bottom: 4px;'><?php echo e($key); ?></a></li>
                        ...
                        <ul class="clearfix">
                            <?php $__currentLoopData = $zys; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $zy): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <div class="col-md-2 col-sm-3 col-xs-4">
                                    <a class="videopic lazy" href="/play/<?php echo e($zy['url']); ?>.html" title="<?php echo e($zy['title']); ?>" data-src="<?php echo e($zy['img']); ?>" onclick="jilu(this)"><span class="play hidden-xs"></span><span class="score"><?php echo e($zy['js']); ?></span></a>
                                    <div class="title">
                                        <h5 class="text-overflow"><a href="/play/<?php echo e($zy['url']); ?>.html" title="<?php echo e($zy['title']); ?>" src="<?php echo e($zy['img']); ?>" onclick="jilu(this)"><?php echo e($zy['title']); ?></a></h5>
                                    </div>
