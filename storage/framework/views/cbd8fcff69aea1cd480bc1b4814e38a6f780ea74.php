					...
					<div class="stui-player__video embed-responsive-16by9 embed-responsive clearfi">
						...
						<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?></span>
                           ...
                           <span class="text-muted" id="xuji">正在播放：<?php echo e($pm); ?></span>
							<a class="detail-more" href="javascript:;">详情 <i class="icon iconfont icon-moreunfold"></i></a><a href="javascript:;" class="zshang more pull-right" onclick="pop()"></a></p>
							<div class="detail-content" style="display: none;">
								<p class="data"><span class="text-muted">类型：</span>综艺</p>
	...
	<div class="stui-pannel-box">
		<div class="stui-pannel_hd">
			<div class="stui-pannel__head bottom-line active clearfix">
              <a class="accordion-toggle" data-toggle="collapse" data-parent="#accordion" href="#zy">
		...
		<div class="stui-pannel_bd col-pd clearfix">
			<ul class="stui-content__playlist column10 clearfix collapse in" id="zy">  
			<?php $__currentLoopData = $zylist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
			<li><a href="<?php echo e(isset($v['href'])?$v['href']:'#'); ?>" target="_self"  class="am-btn am-btn-default lipbtn" data-href='#ys' onclick="bofang(this)"><?php echo e(isset($v['href'])?$v['time']:'暂无可用播放源'); ?></a></li>
