...
<?php $__env->startSection('userinfo','active opened active'); ?>
<?php $__env->startSection('changeinfo','active'); ?>
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-1" value="<?php echo e(session('username')); ?>" name="user_name" disabled = "disabled" required>
                            </div>
                        </div>
                        <div class="form-group">
