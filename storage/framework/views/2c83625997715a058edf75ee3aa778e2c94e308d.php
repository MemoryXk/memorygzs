   ...
   <div class="container">
    <div class="row">
     <div class="stui-header_bd clearfix">
      ...
      <input type="text" class="form-control ff-wd" id="sos" name="key" placeholder="请输入片名">
...
<div class="container">
   ...
   <p class="text-center"><?php echo config('webset.webtongji'); ?></p>
                <p class="text-center"> 本站提供的最新电影和电视剧资源均系收集于各大视频网站,本站只提供web页面服务,并不提供影片资源存储,也不参与录制、上传<br/>若本站收录的节目无意侵犯了贵司版权，请给邮箱：1509095490@qq.com来信,我们会及时处理和回复<br></p> 
