                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="hidden" value="<?php echo e($yq['yq_id']); ?>" name="yq_id">
                                <input type="text" class="form-control" id="field-1" value="<?php echo e($yq['yq_name']); ?>" name="yq_name" placeholder="请输入友链名称" required>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="field-3" name="yq_link" value="<?php echo e($yq['yq_link']); ?>" placeholder="请输入友链地址" required>
                            </div>
                        </div>
                        <div class="form-group-separator"></div>
                        <div class="form-group">
