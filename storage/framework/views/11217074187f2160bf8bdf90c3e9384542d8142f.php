...
<?php $__env->startSection('cacheset','active'); ?>
                ...
                <div class="panel-body">
                    ...
                    <form role="form" class="form-horizontal" id="myform" enctype="multipart/form-data">
                        <div class="form-group">
                            <label class="col-sm-2 control-label" for="field-6">首页缓存开关</label>
                            <div class="col-sm-9">
                                <div class="form-block">
                                    <input type="checkbox" id="filed-6" name="cacheswitch" <?php echo e(config('cacheconfig.cacheswitch')?'checked':''); ?> class="iswitch iswitch-primary">
                                </div>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <div class="form-block">
                                    <input type="checkbox" id="filed-6" name="autocache" <?php echo e(config('cacheconfig.autocache')?'checked':''); ?> class="iswitch iswitch-primary">
                                </div>
                            </div>
                        </div>
