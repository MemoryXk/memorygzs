        ...
        <div class="col-sm-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">编辑用户<?php echo e($user['user_name']); ?></h3>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control datepicker" id="field-1" name="user_vip_time" value="<?php echo e($user['user_vip_time']>time()?date('Y-m-d',$user['user_vip_time']):''); ?>" data-format="yyyy-mm-dd" placeholder="会员到期时间为空或者小于当前时间则不开通或者关闭会员资格">
