...
$("#首页").attr("class","active");
   ...
   <div class="row">
	...
	<div class="stui-pannel stui-pannel-bg clearfix">
     <div class="stui-pannel-box clearfix">
            <marquee style="width: 100%;color: #3ACEED;font-size: 20px;padding-top: 5px;padding-bottom: 5px;"><?php echo e(config('webset.notice')); ?></marquee>
                      </div>
                    </div>
                        </div>
                    </div>
       ...
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
		 ...
		 <ul class="nav nav-text pull-right <?php if($loop->index>4): ?> hidden-xs hidden-md <?php endif; ?>">
			<li><a href="/autocxlist/<?php echo e($type); ?>/1.html" class="text-muted"><?php echo e($key); ?></a> <span class="split-line"></span></li>
		 </ul>
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
		 ...
		 <ul class="nav nav-text pull-right <?php if($loop->index>4): ?> hidden-xs hidden-md <?php endif; ?>">
			<li><a href="/movielist/<?php echo e($type); ?>/1.html" class="text-muted"><?php echo e($key); ?></a> <span class="split-line"></span></li>
		 </ul>
       ...
       <div class="stui-pannel_bd clearfix">
        <ul class="stui-vodlist clearfix">
		 ...
		 <li class="col-md-5 col-sm-4 col-xs-3 <?php if($loop->index>4): ?> hidden-lg hidden-md <?php endif; ?>" id="vodlist-<?php echo e($dy['url']); ?>">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/<?php echo e($dy['url']); ?>.html" onclick="jilu(this)" title="<?php echo e($dy['title']); ?>" data-src="<?php echo e($dy['img']); ?>">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
		 ...
		 <ul class="nav nav-text pull-right <?php if($loop->index>4): ?> hidden-xs hidden-md <?php endif; ?>">
			<li><a href="/tvlist/<?php echo e($type); ?>/1.html" class="text-muted"><?php echo e($key); ?></a> <span class="split-line"></span></li>
		 </ul>
		 <?php if($loop->index==3) break; ?>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        ...
        <?php $__currentLoopData = $dsjs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dsj): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		 <li class="col-md-5 col-sm-4 col-xs-3 <?php if($loop->index>4): ?> hidden-lg hidden-md <?php endif; ?>" id="vodlist-<?php echo e($dsj['url']); ?>">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/<?php echo e($dsj['url']); ?>.html" onclick="jilu(this)" title="<?php echo e($dsj['title']); ?>" data-src="<?php echo e($dsj['img']); ?>">
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
		 ...
		 <ul class="nav nav-text pull-right <?php if($loop->index>4): ?> hidden-xs hidden-md <?php endif; ?>">
			<li><a href="/zylist/<?php echo e($type); ?>/1.html" class="text-muted"><?php echo e($key); ?></a> <span class="split-line"></span></li>
		 </ul>
		 <?php if($loop->index==3) break; ?>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
      ...
      <div class="col-lg-wide-75 col-xs-1 padding-0">
       <div class="stui-pannel_hd">
        <div class="stui-pannel__head clearfix">
		 ...
		 <ul class="nav nav-text pull-right <?php if($loop->index>4): ?> hidden-xs hidden-md <?php endif; ?>">
			<li><a href="/dmlist/<?php echo e($type); ?>/1.html" class="text-muted"><?php echo e($key); ?></a> <span class="split-line"></span></li>
		 </ul>
		 <?php if($loop->index==3) break; ?>
         <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </div>
       ...
       <div class="stui-pannel_bd clearfix">
        ...
        <?php $__currentLoopData = $dms; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dm): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		 <li class="col-md-5 col-sm-4 col-xs-3 <?php if($loop->index>4): ?> hidden-lg hidden-md <?php endif; ?>" id="vodlist-<?php echo e($dm['url']); ?>">
          <div class="stui-vodlist__box">
           <a class="stui-vodlist__thumb lazyload img-shadow" href="/play/<?php echo e($dm['url']); ?>.html" onclick="jilu(this)" title="<?php echo e($dm['title']); ?>" data-src="<?php echo e($dm['img']); ?>">
