...
<?php $__env->startSection('yqlist','active'); ?>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <table class="table table-bordered table-striped" id="example-2">
                ...
                <?php $__currentLoopData = $yqlist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key=>$v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr>
                        <td><?php echo e($v['yq_name']); ?></td>
                        <td><?php echo e($v['yq_link']); ?></td>
                        <td>
                            <a href="/<?php echo e(config('webset.webdir')); ?>/edityqlink/<?php echo e($v['yq_id']); ?>" class="btn btn-secondary btn-sm btn-icon icon-left">
                                编辑
                            </a>

                            <a href="javascript:void(0)" onclick="shanchu(this)" goodid="<?php echo e($v['yq_id']); ?>" class="btn btn-danger btn-sm btn-icon icon-left">
                                删除
                            </a>
                        </td>
                    </tr>
    ...
    <script>
        function shanchu(obj) {
            layer.confirm('您确认要删除？', {
                ...
                $.ajax({
                    url:'/action/delyqlink',
                    type:'post',
                    headers: {
                        'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content'),
                        'token':localStorage.getItem('token'),
                    },
                    data:{yq_id:$(obj).attr('goodid')},
                    dataType:'json',
