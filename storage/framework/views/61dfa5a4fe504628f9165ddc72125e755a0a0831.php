            ...
            <div class="hy-player clearfix">
                <div class="item">
                    <div class="col-md-9 col-sm-12 padding-0">
                            ...
                            <ul class="cleafix hidden-sm hidden-xs">
                                <li>
                                    <a class="btn btn-sm btn-default" id="btn-pre">
                                        <i class="icon iconfont icon-rewind1"></i> 上一期
                                    </a>
                                </li>
                                <li class="">
                                    <a class="btn btn-sm btn-default" id="btn-next">下一期
                       ...
                       <p style="text-align:center;color:#000;font-size: 10px;background: #3ACEED;padding:11px 8px;border-radius: 2px;">
						温馨提示：超过12秒未开始播放，或在播放过程出现严重卡顿，请手动切换线路或播放源，以获得优质的观影体验！</p>
                    </div>
                                ...
                                <div class="item tyui" id="dianshijuid">
                                    <div class="panel clearfix">
                                        <a class="option collapsed" data-toggle="collapse" data-parent="#playlist"
                                           href="#playlist1">播放列表<span class="text-muted pull-right"><i
                                        ...
                                        <div id="playlist1" class="playlist collapse in dianshijua">
                                            <ul class="playlistlink-1 list-15256 clearfix">
                                                <?php $__currentLoopData = $zylist; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $v): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <li>
                                                        <a href="javascript:void(0)" target="_self"  class="am-btn am-btn-default lipbtn" style="" data-href='<?php echo e(isset($v['href'])?$v['href']:'#'); ?>' onclick="bofang(this)"><?php echo e(isset($v['href'])?$v['time']:'暂无可用播放源'); ?></a>
                                                    </li>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                            </ul>
