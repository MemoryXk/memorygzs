...
class CoreController extends Controller
{
	...
	public function dyList($_var_2, $_var_3)
	{
		...
		$_var_5 = ['title' => ['ul:eq(8) .s1', 'text', ''], 'url' => ['ul:eq(8) a.js-tongjic', 'href', '', function ($_var_6) {
			return base64_encode($this->domin . $_var_6);
		}], 'img' => ['ul:eq(8) .cover.g-playicon img', 'src', ''], 'pf' => ['ul:eq(8) .s2', 'text', ''], 'year' => ['ul:eq(8) .hint', 'text'], 'star' => ['ul:eq(8) .star', 'text', '']];
	...
	{
		$_var_27 = ['title' => ['.title-left.g-clear h1', 'text', ''], 'desc' => ['.item-desc.js-close-wrap', 'text', '-span'], 'playname' => ['.top-list-zd.g-clear a[data-daochu^="to="]', 'text', '-span'], 'play' => ['.top-list-zd.g-clear a[data-daochu^="to="]', 'href', '', function ($_var_28) {
	...
	{
		$_var_34 = ['title' => ['.title-left.g-clear h1', 'text', ''], 'desc' => ['.item-desc.js-close-wrap', 'text', '-span']];
	...
	{
		$_var_37 = ['bt' => ['.title-left.g-clear h1', 'text', ''], 'zd' => ['.ea-site', 'text', ''], 'desc' => ['.item-desc.js-close-wrap', 'text', '-span'], 'title' => ['.js-year-page .s1', 'text', ''], 'href' => ['.js-year-page a.js-link', 'href'], 'time' => ['.js-year-page .w-newfigure-hint', 'text', '']];
	...
	{
		$_var_40 = ['title' => ['.tuijian-list .s1', 'text', ''], 'url' => ['.tuijian-list a', 'href', '', function ($_var_41) {
			return base64_encode($this->domin . $_var_41);
		}], 'img' => ['.tuijian-list img', 'data-src']];
	...
	public function getTDLike($_var_43 = 'tv', $_var_44)
	{
		if ($_var_43 == 'tv') {
			...
			$_var_45 = ['title' => ['.m-guess-list .title', 'text', ''], 'url' => ['.m-guess-list .title a', 'href', '', function ($_var_47) {
	...
	public function getSearch($_var_49, $_var_50 = "")
	{
		...
		$_var_52 = ['dy_title' => ['.b-mainpic_new a', 'title', ''], 'dy_addr' => ['.b-mainpic_new a', 'href', '', function ($_var_53) use($_var_50) {
		...
		}], 'dy_img' => ['.b-mainpic_new a img', 'src', ''], 'dy_type' => ['.cont .playtype', 'text', ''], 'dy_desc' => ['.js-b-fulldesc', 'data-full']];
